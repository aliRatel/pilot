...
Container getAddJobContainer(double height, double width,BuildContext context) {
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        Container(
          ...
          child: GestureDetector(onTap: ()=> Navigator.push(context, MaterialPageRoute(builder: (context) => AddJobPage(),)),
            child: DottedBorder(
