...
class _AddJobPageState extends State<AddJobPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(onWillPop: _willPopCallBack,
      child: Scaffold(
        appBar: PreferredSize(preferredSize: Size.fromHeight(200),child: AppBar(backgroundColor: mainColor,title:Text('Add a new job'),centerTitle: true,shape: CustomShapeBorder(),))
              ,
        body: ListView(
          children: [
            Form(
